...
| Phase | Status | Notes |
| --- | --- | --- |
| Phase 0 - Foundation | In progress | Repo setup, state stores, terminal base |
| Phase 1 - Core OS | In progress | Boot flow delivered; filesystem and shell parser remain |
...
| Phase 4 - Optional Advanced OmOS | Not started | Only after core product proves out |
